...
export interface TranslationSchema {
  ...
  skaters: {
    title: string;
    subtitle: string;
    spotMapPrompt: string;
    spotMapLink: string;
    spotMapSuffix: string;
    searchPlaceholder: string;
    searchLabel: string;
    statSkaters: string;
    ...
    activeNowSubtitle: string;
    activeNowEmpty: string;
    noResults: string;
    ...
    layerSkaters: string;
    layerSpots: string;
    layerSpotsLoading: string;
    layerSpotsFailed: string;
    viewSpot: string;
    youAreHere: string;
    spotsAdded: string;
  };
