...
export interface TranslationSchema {
  ...
  invite: {
    ...
    unknownError: string;
    pleaseLoginHive: string;
    needHiveAccount: string;
    ...
    modeHive: string;
    modeHiveDesc: string;
    modeHiveLocked: string;
    liteSendButton: string;
    liteInviteSent: string;
    liteInviteFailed: string;
    actNoneAvailable: string;
    rescueTitle: string;
    rescueBody: string;
    rescueDownload: string;
    rescueUsername: string;
    rescueMasterPassword: string;
    rescueSendTo: string;
    stepType: string;
    stepDetails: string;
    badgeFree: string;
